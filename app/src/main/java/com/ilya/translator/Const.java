 ...
 */
public class Const {
  final static String TRANSLATION_API_URL = "https://translate.yandex.net/api/v1.5/tr.json/";
  final static String DICTIONARY_API_URL = "https://dictionary.yandex.net/api/v1/dicservice.json/";
